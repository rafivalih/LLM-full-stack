...
export default function Home() {
	...
	return (
		<main className="min-h-screen bg-white flex flex-col">
			{/* Header */}
			<header className="h-16 border-b border-gray-200 flex items-center px-5">
				<h1 className="text-xl font-semibold text-gray-900">LLM AI </h1>
			</header>
					...
					{!answer && !loading ? (
						<div className="h-full flex items-center justify-center">
							<div className="text-center">
								...
								<p className="mt-3 text-gray-500">Ask me anything</p>
							</div>
						</div>
					) : (
						<div className="mt-5">
							<div className="mb-6">
								<p className="text-sm font-medium text-gray-500 mb-2">You</p>

								<p className="text-gray-900 text-lg">{question}</p>
							</div>

							<div>
								<p className="text-sm font-medium text-gray-500 mb-2">llm AI</p>
